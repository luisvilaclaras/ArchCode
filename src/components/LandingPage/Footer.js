    ...
    <footer className="bg-[#1e3047] py-12 px-6 text-white font-personalizada">
      <div className="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-x-8 gap-y-4">
        ...
        <div className="mb-4 md:-ml-48 text-center">
          <img src="/images/ArchCode.webp" alt="ArchCode Logo" className="h-12 w-auto mx-auto cursor-pointer" onClick={() => handleScrollToSection('home')} />
      ...
      <div className="mt-8 flex items-center justify-between text-gray-400 border-t border-gray-700 pt-6">
        ...
        <div className="flex space-x-4">
          <a href="#"><img src="/images/instagram.webp" alt="Instagram" className="h-6 w-6 hover:text-white transition" /></a>
