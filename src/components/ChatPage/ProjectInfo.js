                            ...
                            <div className="flex flex-col w-1/3 pr-4 border-r border-gray-300">
                                <div className="flex mb-4 gap-2">
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded ${inputMode === 'manual' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} hover:bg-blue-700`}
                                    >
                                        Manual
                                    </button>
                                    <button
                                        onClick={() => handleModeSwitch('automatic')}
                                        className={`px-4 py-2 rounded ${inputMode === 'automatic' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} hover:bg-blue-700`}
                                    >
                                        Automático
                                    </button>
                                </div>
                                ...
                                {inputMode === 'manual' && (
                                  <div className="flex flex-col items-center mb-4 gap-2">
                                      <div className="flex flex-col w-full px-4"> {/* Ancho completo con padding para alineación */}
                                          <input
                                              type="text"
                                              placeholder="Etiqueta manual"
                                              value={newTag.name}
                                      ...
                                      <button
                                          ...
                                          className="flex items-center justify-center w-8 h-8 bg-blue-500 text-white rounded-full shadow hover:bg-blue-700 transition-colors duration-300 mt-2"
                                      >
                                          <FaPlus />
                                      </button>
                                  </div>
