...
import SignUpPopup from '@/components/LandingPage/SignUpPopUp';
...
export default function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>La IA definitiva para arquitectos | Tu sitio web</title>
        <meta
          name="description"
          content="Acelera tus proyectos con la potencia de la IA para arquitectos y gana tiempo."
        />
        <meta
          name="keywords"
          content="arquitectura, IA, inteligencia artificial, CTE, proyectos, normativa, arquitectos, eficiencia"
        />
      </Head>
      ...
      <div>
        ...
        <main>
          <section
            id="home"
            className="font-personalizada hero bg-[#1e3047] text-white h-auto flex items-center justify-center pt-40 pb-20"
          >
            ...
            <div className="flex justify-center space-x-6">
              <div className="bg-[#344e6f] p-6 shadow-lg rounded-lg w-64">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  Analiza rápidamente una gran cantidad de códigos técnicos,
                  permitiendo buscar y encontrar fácilmente entre normativas
                  específicas.
                </p>
              </div>
              <div className="bg-[#344e6f] p-6 shadow-lg rounded-lg w-64">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  Identifica recursos valiosos que podrías haber pasado por alto
                  en tu investigación, optimizando el tiempo y esfuerzo.
                </p>
              </div>
              <div className="bg-[#344e6f] p-6 shadow-lg rounded-lg w-64">
                {/* Imagen encima del título */}
                ...
                <p className="text-sm text-gray-300 mt-2">
                  Desglosa y analiza grandes volúmenes de códigos y asambleas
                  sin complicaciones.
                </p>
              </div>
            </div>
